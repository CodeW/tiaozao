...
return  array(
    ...
    'COOKIE_PREFIX'         => 'tiaozao_',  // Cookie前缀 避免冲突
    ...
    'DB_NAME'               => 'tiaozao',		// 数据库名
    'DB_USER'               => 'root',      	// 用户名
    'DB_PWD'                => 'why6611415',    // 密码
    'DB_PORT'               => '3306',        	// 端口
    'DB_PREFIX'             => '',    			// 数据库表前缀
    ...
    'URL_MODEL'             => 1,       // URL访问模式,可选参数0、1、2、3，分别代表：0 (普通模式); 1 (PATHINFO 模式); 2 (REWRITE  模式); 3 (兼容模式)  默认为PATHINFO 模式，提供最好的用户体验和SEO支持
